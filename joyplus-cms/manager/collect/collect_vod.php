...
switch ($action) {
    ...
    case "noInflowProject" :
        noInflowProject();
        break;

    case "AllInflowProject" :
        AllInflowProject();
        break;
    case "main"  :
        main();
...
function editsave()
{
    ...
    $m_typeid = be("post", "m_typeid");
    $m_area = be("post", "m_area");
    $m_playfrom = be("post", "m_playfrom");
    $m_starring = be("post", "m_starring");
    $m_pic = be("post", "m_pic");
    $m_content = be("post", "m_content");
    $m_zt = be("post", "m_zt");
    $m_language = be("post", "m_language");
    $m_year = be("post", "m_year");
    $m_playserver = be("post", "m_playserver");
    $m_hits = be("post", "m_hits");
    $m_state = be("post", "m_state");
        ...
        <table class=tb>
            ...
            <tr>
                ...
                <td><input id="m_year" name="m_year" type="text"
                           value="<?php echo $m_year ?>" size="50"> &nbsp;人气：<input id="m_hits"
                                                                                    name="m_hits" type="text"
                                                                                    value="<?php echo $m_hits ?>"
                                                                                    size="50">
            ...
            <tr>
                ...
                <td><input type="radio" name="m_zt" value="0"
                        <?php if ($m_zt == 0) {
                            echo "checked";
                        } ?>> 未入库 <input type="radio"
                                         name="m_zt" value="1" <?php if ($m_zt == 1) {
                        echo "checked";
                    } ?>> 已入库
                </td>
            </tr>
