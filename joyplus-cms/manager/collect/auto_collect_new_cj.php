...
function cjList()
{
    ...
    if($p_playtype ==='baidu' ){
        ...
        $baiduList = BaiduParse::parseMovieListByContent($strListCode, $p_coding, '');
...
function cjBaiduView($id,$num){
    global $idarr,$linkarr,$starringarr,$titlearr,$picarr,$areaarr,$yeararr,$typearr,$p_collect_type;
    ...
    if (isN($id) || $id ==="") {
        ...
        if($p_collect_type ===1 || $p_collect_type ==='1') {
            ...
            $p_collect_type->sites=BaiduParse::parseArrayTV($content);
        }else if($p_collect_type ===3 || $p_collect_type ==='3'){
